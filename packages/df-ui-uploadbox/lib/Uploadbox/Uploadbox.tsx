...
export const Uploadbox = React.forwardRef<HTMLDivElement, UploadboxProps>(
  (props, ref) => {
    ...
    return (
      <UploadboxRoot
        sx={{ ...props.sx, width: props.boxWidth ? props.boxWidth : "100%" }}
        ref={ref}
      >
              ...
              {props.tooltip ? (
                <Tooltip title={props.title}>
                  <Typography
                    ...
                    variant="subtitle2"
                    width={props.maxWidthTitle ? props.maxWidthTitle : "100%"}
                  >
                    {props.title}
                  </Typography>
                </Tooltip>
          ...
          >
            {props.hideDataSize ? (
              ...
              <Typography
                ...
                variant="body2"
              >
                {props.uploadedDataSize + " / " + props.filesize}
              </Typography>
            )}
            {props.hidePercentage ? (
              ...
              <Typography
                ...
                variant="body2"
              >
                {props.uploadPercentage.toFixed(0) + "%"}
              </Typography>
            )}
          </Box>
